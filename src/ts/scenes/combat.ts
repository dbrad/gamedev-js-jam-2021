import { AbilityColour, AbilityCooldown, AbilityName, AbilityType, GemType } from "../gameplay/ability";
import { CurrencyKeys, Enemy, enemyColour, gameState } from "../gameplay/gamestate";
...
import { createAbilityBarNode, updateAbilityBar } from "../nodes/ability-bar-node";
import { createCombatBarNode, updateCombatBarValues } from "../nodes/combat-bars-node";
import { createSprite, node_sprite_colour, node_sprite_timestamp } from "../nodes/sprite-node";
...
export function prepareCombatScene(enemy: Enemy): void
{
  ...
  if (enemy)
  {
    ...
    node_sprite_colour[enemySpriteId] = enemyColour[gameState.currentLevel.realm];
    node_sprite_colour[enemyDyingSpriteId] = enemyColour[gameState.currentLevel.realm];
  }
